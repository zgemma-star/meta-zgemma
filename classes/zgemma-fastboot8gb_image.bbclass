...
IMAGE_TYPEDEP_zgemmafastboot8gb = "ext4"
...
IMAGE_CMD_zgemmafastboot8gb () {
    ...
    ext2simg -zv ${IMGDEPLOYDIR}/${IMAGE_NAME}${IMAGE_NAME_SUFFIX}.ext4 ${IMGDEPLOYDIR}/${IMAGE_NAME}${IMAGE_NAME_SUFFIX}.zgemmafastboot8gb.gz
}
